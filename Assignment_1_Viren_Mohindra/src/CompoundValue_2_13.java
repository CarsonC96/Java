...
public class CompoundValue_2_13 {

	public static void main(String[] args) {
		
		  String amt_in = JOptionPane.showInputDialog("Enter the monthly saving amount: ");
		  
		  double amt = Double.parseDouble(amt_in);
		 
		  double compound = 0;
		  for (int i = 0; i < 6; i++) {
		  compound = (amt + compound) * (1 + 0.00417);
		  }
		  
		  JOptionPane.showMessageDialog(null, "After the sixth month, the account value is " + compound);
